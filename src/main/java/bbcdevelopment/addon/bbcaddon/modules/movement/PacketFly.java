...
/*
 * This module was ported from Cally's Git Repo, full credits to him for porting this into 1.19 from Konas Leak. https://github.com/cally72jhb/vector-addon
 * */

public class PacketFly extends BBCModule {
    ...
    public void onPostTick(TickEvent.Post event) {
        ...
        switch (type.get()) {
            ...
            case ONGROUND -> {
                ...
                for (double i = 0.0625; i < speed.get(); i += 0.262) {
                    double[] dir = PlayerHelper.directionSpeed((float) i);
